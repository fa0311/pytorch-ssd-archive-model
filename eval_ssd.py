...
class MeanAPEvaluator:
    ...
    def __init__(self, dataset, net, arch='mb1-ssd', eval_dir='models/eval_results', 
        ...
        elif arch == 'mb2-ssd-lite' or arch == "mb3-large-ssd-lite" or arch == "mb3-small-ssd-lite":
...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16-ssd':
        ...
        net = create_mobilenetv3_large_ssd_lite(len(dataset.class_names), is_test=True)
    elif args.net == 'mb3-small-ssd-lite':
        net = create_mobilenetv3_small_ssd_lite(len(dataset.class_names), is_test=True)
    else:
